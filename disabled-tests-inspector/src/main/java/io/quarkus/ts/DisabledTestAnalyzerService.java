...
public class DisabledTestAnalyzerService {
    ...
    private static final Pattern ISSUE_PATTERN = Pattern.compile(
            "(https://(?:github\\.com/.+?/issues/\\d+|issue\\.redhat\\.com/.+?/browse/[a-z]+-\\d+))"
    );


    public List<BranchAnalysisResult> analyzeRepository(String repoOwner, String repoName, List<String> branches) throws IOException, InterruptedException {
...
//        }
    ...
    private List<DisabledTest> extractDisabledTests(String filePath, String fileContent2) throws InterruptedException {
    ...
    """;
        ...
        Pattern issuePattern = Pattern.compile("(https://(?:github\\.com/.+?/issues/\\d+|issue\\.redhat\\.com/.+?/browse/[a-z]+-\\d+))");
        ...
        for (String line : lines) {
            ...
            Matcher testMethodMatcher = testPattern.matcher(line);
...
//                System.out.println("Found test method: " + testMethodMatcher.group(1));
            ...
            Matcher disabledMatcher = disabledPattern.matcher(line);
...
//                System.out.println("Annotation type: " + annotationType);
                ...
                if (line.contains("//") && issueLink == null) {
                    if (reason == null) {
                        reason = getDisablingReasonComment(line);
